...
function App() {
  ...
  return (
    <div
      className="relative flex min-h-screen w-full flex-col items-center overflow-hidden bg-[#FFFCF8] px-6 py-8 font-sans text-stone-600 select-none"
    ...
    >
      ...
      <div className="z-10 flex w-full flex-1 flex-col items-center" style={{ paddingBottom: buttonPadding }}>
        <div className="flex w-full max-w-md flex-1 flex-col items-center justify-center pt-16 pb-10">
        ...
        <div
          className={`z-10 flex w-full max-w-md items-center justify-center transition-all duration-700 ease-in-out ${isRunning ? "pt-6" : "pt-10"}`}
        >
                      ...
                      >
                        {[0.4, 1.0, 0.6, 0.8, 0.5].map((height, i) => (
                          <motion.span
                            ...
                            transition={{
                              duration: [0.8, 1.2, 1.0, 0.9, 1.1][i],
                              repeat: Infinity,
                              ease: "easeInOut",
                              delay: i * 0.1,
                            }}
